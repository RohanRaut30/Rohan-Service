  ...
  return (
    <>
      ...
      <button
        ...
        className="group relative flex items-center justify-between gap-4 rounded-full border border-surfaceBorder bg-surface px-4 py-2 text-sm text-zinc-600 dark:text-zinc-400 backdrop-blur-md transition-all hover:border-foreground/20 hover:text-foreground"
      >
        <div className="flex items-center gap-2">
          <Search className="h-4 w-4" />
          <span>Ask AI to filter projects...</span>
        </div>
        <kbd className="hidden rounded bg-foreground/10 px-2 py-0.5 font-mono text-[10px] text-zinc-700 dark:text-zinc-300 sm:inline-block">
          Ctrl K
        </kbd>
      </button>
              ...
              <div className="p-4 h-64 overflow-y-auto no-scrollbar">
                {query ? (
                  ...
                  <div className="text-sm text-zinc-500">
                    ...
                    <button className="w-full text-left rounded-lg px-2 py-2 hover:bg-foreground/5 transition-colors">
