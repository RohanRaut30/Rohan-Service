  ...
  return (
    <AnimatePresence>
      {stage < 1 && (
        ...
        >
          <div className="flex flex-col items-start font-mono text-blue-600 dark:text-neonCyan w-full max-w-2xl px-6">
            <div className="flex items-center gap-3 mb-4">
              <Terminal className="w-8 h-8 animate-pulse" />
              <span className="text-2xl md:text-3xl font-bold">SYSTEM_INITIALIZATION</span>
            </div>

            <div className="space-y-3 text-base md:text-lg text-zinc-700 dark:text-zinc-300 w-full">
              {stage >= 0 && (
              ...
              <div className="h-1.5 w-full bg-foreground/10 mt-8 overflow-hidden rounded-full">
                <motion.div
                  initial={{ width: "0%" }}
                  animate={{ width: "100%" }}
