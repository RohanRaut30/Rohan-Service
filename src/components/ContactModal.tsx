              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-foreground/5 border border-foreground/10 rounded-lg px-4 py-2.5 text-foreground placeholder-zinc-500 focus:outline-none focus:border-neonCyan transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-foreground/5 border border-foreground/10 rounded-lg px-4 py-2.5 text-foreground placeholder-zinc-500 focus:outline-none focus:border-neonCyan transition-colors resize-none"
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-foreground text-background font-semibold rounded-lg px-4 py-3 hover:bg-zinc-200 transition-colors disabled:opacity-70"
                >
                  {status === "loading" ? (
