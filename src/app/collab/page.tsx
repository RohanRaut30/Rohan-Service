...
import { Lock, FileText, CheckCircle2, MessageSquare, Clock, ArrowRight } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative overflow-hidden bg-background">
        ...
        <Header activePage="collab" onContactClick={() => setIsContactModalOpen(true)} />

        <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 pt-16 pb-24 flex flex-col items-center">
          
          <div className="text-center max-w-3xl mb-16">
            <div className="flex flex-wrap justify-center items-center gap-3 mb-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-electricPurple/10 border border-electricPurple/20 text-sm text-electricPurple font-mono">
                <Lock className="w-4 h-4" />
                <span>SECURE CLIENT PORTAL</span>
              </div>
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-neonCyan/10 border border-neonCyan/20 text-sm text-neonCyan font-mono animate-pulse shadow-[0_0_15px_rgba(0,240,255,0.2)]">
          ...
          <div className="mt-12">
            ...
            >
              <Lock className="w-10 h-10 text-neonCyan" />
            </motion.div>
